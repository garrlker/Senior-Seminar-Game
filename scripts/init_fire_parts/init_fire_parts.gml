...
global.part_fire = part_type_create();
    ...
    part_type_size(global.part_fire,0.3,0.8,-.05,0);
	...
	part_type_speed(global.part_fire,1,5,-.1,0);
...
global.part_cinder = part_type_create();
    ...
    part_type_size(global.part_cinder,.175,.25,-.001,0);
	...
	part_type_speed(global.part_cinder,3,4,0,0);
