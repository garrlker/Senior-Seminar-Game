...
draw_set_alpha(0.2)
draw_rectangle_color(startx * tile_size,starty * tile_size,endx * tile_size,endy * tile_size,c_white,c_white,c_white,c_white,false)
draw_set_alpha(1)
